...
if ( $senderName && $senderEmail && $senderSubject && $senderCompany && $senderPhone && $message) {
  $recipient = RECIPIENT_NAME . " <" . RECIPIENT_EMAIL . ">";
  $headers = "From: " . $senderName . "";
  $msgBody = " Email:". $senderEmail . "Phone: ". $senderPhone . "Company: ". $senderCompany ."Subject: ". $senderSubject . "Message: " . $message . "";
